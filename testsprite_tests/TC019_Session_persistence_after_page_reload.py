...
async def run_test():
    ...
    try:
        ...
        # Click on 'Get Started Free' to navigate to sign-in or sign-up page to authenticate.
        ...
        # Reload the page to verify session remains active without sign-out.
        ...
        # Re-authenticate user to confirm login and then perform Firestore read/write operations to check for permission errors.
        frame = context.pages[-1]
        elem = frame.locator('xpath=html/body/div/div/div/div/div[2]/form/div/div/input').nth(0)
        await page.wait_for_timeout(3000); await elem.fill('test@vayra.digital')
        ...
        # Perform Firestore read and write operations requiring permissions to check for any permission errors.
        frame = context.pages[-1]
        elem = frame.locator('xpath=html/body/div/div/div[2]/div/div/div/div/div/form/div/input').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
