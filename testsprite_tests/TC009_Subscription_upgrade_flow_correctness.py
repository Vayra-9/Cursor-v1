...
async def run_test():
    ...
    try:
        ...
        # Try to navigate to the login or sign-in page by searching for relevant links or buttons.
        await page.mouse.wheel(0, window.innerHeight)
        

        # Try to navigate directly to the sign-in page or upgrade page URL or open a new tab to access login.
        ...
        # Click the first 'Upgrade to Starter' button to initiate the upgrade process.
        frame = context.pages[-1]
