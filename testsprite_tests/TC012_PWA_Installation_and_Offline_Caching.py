...
async def run_test():
    ...
    try:
        ...
        # Click 'Start Your Journey' to proceed inside the app and check for PWA features
        frame = context.pages[-1]
        elem = frame.locator('xpath=html/body/div/div/section/div/div/div[2]/a').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        # Input email and password, then click Sign In to authenticate and access main app interface
        frame = context.pages[-1]
        ...
        # Click 'Back to Dashboard' to navigate to main dashboard and check for PWA features
        frame = context.pages[-1]
