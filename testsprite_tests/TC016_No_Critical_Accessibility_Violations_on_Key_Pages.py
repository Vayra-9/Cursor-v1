...
async def run_test():
    ...
    try:
        ...
        # Navigate to Dashboard page to run axe-core accessibility scan.
        frame = context.pages[-1]
        elem = frame.locator('xpath=html/body/div/div/section/div/div/div[2]/a').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        # Sign in using provided credentials to access Dashboard page for axe-core scan.
        frame = context.pages[-1]
        ...
        # Click 'Back to Dashboard' button to navigate to Dashboard page.
        frame = context.pages[-1]
