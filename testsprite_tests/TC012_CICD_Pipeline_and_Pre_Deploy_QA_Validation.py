...
async def run_test():
    ...
    try:
        ...
        # Click on 'Sign in' to log into GitHub.
        frame = context.pages[-1]
        elem = frame.locator('xpath=html/body/div/div[3]/header/div/div[2]/div/div/div/a').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        # Input username and password, then click 'Sign in' button to log into GitHub.
        frame = context.pages[-1]
